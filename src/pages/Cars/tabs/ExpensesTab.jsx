...
export default function ExpensesTab({ carId }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Add Expense Modal */}
      <Modal open={showAdd} onClose={() => setShowAdd(false)} title="Log Expense" subtitle="Record a vehicle expense">
...
function FilterBtn({ active, onClick, children }) {
  const { cn: _cn } = { cn: (...c) => c.filter(Boolean).join(' ') };
  return (
